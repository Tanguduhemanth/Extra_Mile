...
<body>
    ...
    <table>
        ...
        <div class="text">Customer Details</div>
           ...
           <form>
           <label>Name :</label>
           <input class="a" type="text" name="user name" placeholder="Enter Your Name" required><br>
           <label>Phone no:</label>
           <input class="b" type="number" name="user name" placeholder="Enter Your Number" required><br>
           </form>
           <label>Address   :</label>
           <input class="c" type="text" name="user name" placeholder="Enter Your Address" required><br></div>
        </div> 
        ...
        <section class="footer">
			<footer class="footer-distributed">
				<div class="footer-left">
					...
					<p class="footer-company-name">Copyright @ 2023 <strong>Extra Mile</strong>
